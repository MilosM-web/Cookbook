...
function cookbook_scripts() {
	wp_enqueue_style( 'cookbook-style', get_stylesheet_uri() );

	wp_enqueue_script( 'cookbook-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
	wp_enqueue_script( 'cookbook-js', get_template_directory_uri() . '/js/global.js', array(), '20151215', true );

	wp_enqueue_script( 'cookbook-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
require get_template_directory() . '/inc/new-recipe.php';
